...
class StarWarsCog(commands.Cog):
    ...
    async def order66(self, interaction: discord.Interaction):
        embed = discord.Embed(
            ...
            description=(
                ...
                "Every Jedi is now an enemy of the Republic. Good soldiers follow orders."
            ),
            color=DARK,
        )
    ...
    async def watchthosewristrockets(self, interaction: discord.Interaction):
        embed = discord.Embed(
            ...
            description='*"Whoa, whoa, whoa! Watch those wrist rockets, Waxer!"*\n\n— Commander Cody',
            color=DARK,
        )
